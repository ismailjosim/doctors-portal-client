              ...
              <div key={id} className="relative mt-16 mb-32 sm:mb-24">
                <div className="rounded overflow-hidden shadow-lg bg-white">
                  ...
                  <div className="px-6 mt-20">
                    <div className="font-bold text-3xl text-center pb-1 text-secondary">{name}</div>
                    <p className="text-secondary/70 text-sm text-center">{post}</p>
                    <p className="text-secondary/70 text-sm text-center">Email: {email}</p>
                    <p className="text-center text-secondary/65 text-base pt-3 font-normal">
                      {details}
                    </p>
