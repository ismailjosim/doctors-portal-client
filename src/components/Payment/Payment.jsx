...
const Payment = () => {
  ...
  return (
    <div>
      <h3 className="font-bold capitalize text-2xl text-center mt-10 text-secondary">
        service Summary
      </h3>
      <div className="p-8 w-9/12 mx-auto border-2 border-primary my-5 rounded-md bg-white shadow-lg">
        <div className="sm:flex justify-between gap-5">
          ...
          <div className="flex flex-col space-y-4">
            <div>
              <h2 className="text-2xl font-semibold text-secondary">{treatmentName}</h2>
              <span className="text-sm text-secondary/60">service ID: {_id}</span>
            </div>
            <div className="space-y-1">
              ...
              <span className="flex items-center space-x-2 text-xl font-bold text-secondary">
